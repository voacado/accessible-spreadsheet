  ...
  describe('Spreadsheet', (): void => {
    ...
    describe('Empty Spreadsheet Values', (): void => {
      it('an empty spreadsheet should return empty string values at every valid position without errors', (): void => {
        ...
        expect(spreadsheet.getCellAtKeyValue("C3")).toEqual("");
      });
    })
    ...
    describe('Cell Reference', (): void => {
      it('A cell containing a cell reference should return the same display and value, and a correct formula bar display', (): void => {
        ...
        expect(spreadsheet.getCellAtKeyValue("A1")).toEqual(1);
        expect(spreadsheet.getCellAtKeyDisplay("B1")).toEqual("1");
        expect(spreadsheet.getCellAtKeyFormulaBarDisplay("B1")).toEqual("=A1");
        expect(spreadsheet.getCellAtKeyValue("B1")).toEqual(1);
      });
    })
    ...
    describe('Cell Reference Chaining', (): void => {
      it('A cell referencing a cell referencing (etc) should return the same values and displays, even after changes', (): void => {
        ...
        expect(spreadsheet.getCellAtKeyValue("B1")).toEqual(1);
        expect(spreadsheet.getCellAtKeyDisplay("B2")).toEqual("1");
        expect(spreadsheet.getCellAtKeyFormulaBarDisplay("B2")).toEqual("=B1");
        expect(spreadsheet.getCellAtKeyValue("B2")).toEqual(1);
        expect(spreadsheet.getCellAtKeyDisplay("B3")).toEqual("1");
        expect(spreadsheet.getCellAtKeyFormulaBarDisplay("B3")).toEqual("=B2");
