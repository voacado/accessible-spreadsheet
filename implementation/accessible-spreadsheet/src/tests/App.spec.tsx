...
describe('App', () => {
  ...
  it('renders App correctly - file header visible', () => {
    ...
    // File Header - appears
    expect(screen.getByDisplayValue('Untitled Spreadsheet')).toBeInTheDocument();
  });
  ...
  it('renders App correctly - formula bar visible', () => {
    ...
    // Formula bar - appears
    expect(screen.getByPlaceholderText('Enter formula or data...')).toBeInTheDocument();
  });
  ...
  it('renders App correctly - buttons exist', () => {
    ...
    expect(screen.getByRole('button', { name: /Formula/i })).toBeInTheDocument();  
    ...
    expect(screen.getByRole('button', { name: /Clear Row/i })).toBeInTheDocument();  
    expect(screen.getByRole('button', { name: /Insert Column/i })).toBeInTheDocument();  
    expect(screen.getByRole('button', { name: /Delete Column/i })).toBeInTheDocument();  
    expect(screen.getByRole('button', { name: /Clear Column/i })).toBeInTheDocument();  
  ...
  // it('passes the correct props to FileHeader', () => {
  //   render(<App />);
  //   // const fileHeader = getByTestId('fileHeader'); // Add data-testid="fileHeader" to FileHeader
  //   // Test if FileHeader has the correct props or renders the correct content
  // });

  // TODO: test formula pop-up
  // TODO: test load pops up UI
  // TODO: test that props are passed correctly (others can be tested in individual component tests)
